...
public class IntegrationRepositoriesTest {
  ...
  public void column_findAllByProject() {
    ...
    ATable table1 = new ATable(PROJECT_ID1, DATASET_NAME1, TABLE_NAME1);
    ATable table2 = new ATable(PROJECT_ID2, DATASET_NAME1, TABLE_NAME1);
    AColumn column1 = new AColumn(table1.getTableId(), COLUMN_NAME1, COLUMN_TYPE1);
    AColumn column2 = new AColumn(table2.getTableId(), COLUMN_NAME1, COLUMN_TYPE1);
