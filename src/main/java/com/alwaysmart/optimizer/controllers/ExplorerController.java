...
public class ExplorerController {
    ...
    @ApiOperation("Get a project for a given projectId")
    public UpdateMetadataProjectRequestResponse getProjectMetadata(@PathVariable final String projectId) {
    ...
    public void updateProject(@PathVariable final String projectId, @RequestBody final UpdateMetadataProjectRequestResponse request) {
    ...
    public List<DatasetResponse> getDatasets(@PathVariable final String projectId) {
        return fetcherService.fetchAllDatasets(projectId)
                .stream()
    ...
    @GetMapping(path = "/project/{projectId}/dataset/{datasetName}/table", produces = "application/json")
    @ApiOperation("Get all dataset for a given projectId")
    public List<TableResponse> getTables(@PathVariable final String projectId,
                                     @PathVariable final String datasetName) {
        return fetcherService.fetchAllTables(projectId)
                .stream()
    ...
    public DatasetResponse toDatasetResponse(FetchedDataset dataset) {
        ...
        return new DatasetResponse(projectId, datasetName, location, friendlyName, description, createdAt, lastModified);
    }
