...
public class ExplorerController {
	...
	public void updateProject(@PathVariable final String projectId,
	...
	public DatasetResponse toDatasetResponse(FetchedDataset dataset) {
		...
		return new DatasetResponse(projectId, datasetName, location, friendlyName, description, createdAt,
				lastModified);
	}
